    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-purple-50 to-cyan-50">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border-2 border-purple-200 p-8">
          ...
          <p className="text-xl text-purple-600 mb-8">A JavaScript Library for Building User Interfaces</p>
...
export default Hello;`}</code>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-cyan-50 border-2 border-purple-200 rounded-lg p-6 min-h-[300px] flex items-center justify-center">
                {showOutput ? (
                  <div className="text-center">
                    <h1 className="text-4xl font-bold text-purple-700 mb-4">Hello, World!</h1>
                    <p className="text-xl text-gray-700">Welcome to React</p>
                  </div>
                ) : (
                  <div className="text-purple-400">Click "Show Output" to see the result</div>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 bg-cyan-50 border-2 border-cyan-200 rounded-lg p-6">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="flex items-start gap-2">
                <span className="text-purple-500 font-bold">▸</span>
                Created by Facebook (Meta) and maintained by a large community
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-500 font-bold">▸</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-purple-500 font-bold">▸</span>
                Think of React like LEGO blocks for building websites
              </li>
            </ul>
          </div>
        </div>
