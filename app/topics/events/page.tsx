    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-purple-50 to-cyan-50">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border-2 border-purple-200 p-8">
          ...
          <p className="text-xl text-purple-600 mb-8">Responding to User Actions</p>
      ...
      <p>Message: {message}</p>
            ...
            <div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-cyan-50 border-2 border-purple-200 rounded-lg p-6 min-h-[300px] flex items-center justify-center">
                {showOutput ? (
                  ...
                  <div className="text-purple-400">Click "Show Output" to see events in action</div>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 bg-cyan-50 border-2 border-cyan-200 rounded-lg p-6">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="flex items-start gap-2">
                <span className="text-purple-500 font-bold">▸</span>
                You can pass event objects to handlers for more information
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-500 font-bold">▸</span>
                Common events: click, change, submit, hover, focus
              </li>
            </ul>
          </div>
        </div>
...
function EventDemoComponent() {
  ...
  return (
    <div className="bg-white border-2 border-purple-300 rounded-lg p-6 shadow-md w-full space-y-4">
      <Button
        onClick={handleClick}
      ...
      <div className="bg-purple-50 border-2 border-purple-200 rounded-lg p-4">
        <p className="text-gray-700 font-medium">Message: {message || "No message yet"}</p>
      </div>
    </div>
  )
}
